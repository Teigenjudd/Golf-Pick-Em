...
- "Closed pools" toggle exists for golf pools — closed pools should feel clearly archived. CFB tiles don't participate in that toggle yet (no CFB "closed pool" concept built); they always render.
