...
| 3.4 | **Second sport — CFB, chosen and planned (PR0 shipped 2026-08-11)** — college football, weekly against-the-spread/season-cumulative, full schema/UI/data-provider siloing (`docs/CFB_FORMAT.md`, `docs/CFB_BUILD_PLAN.md`, ~11-PR sequence) | Chosen deliberately ahead of golf being fully "proven" — supersedes this row's earlier NFL placeholder; see DECISIONS 2026-08-11. PR1 (`cfb` schema scaffold) shipped 2026-08-11, PR #40 — empty tables + RLS deny-all only. PR2 (RLS policies + submit RPC) is next. | High (later) | 🔴 |
