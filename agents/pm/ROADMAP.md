...
| 3.4 | **Second sport — CFB, in active build (PR0 shipped 2026-08-11)** — college football, weekly against-the-spread/season-cumulative, full schema/UI/data-provider siloing (`docs/CFB_FORMAT.md`, `docs/CFB_BUILD_PLAN.md`, ~11-PR sequence) | Chosen deliberately ahead of golf being fully "proven" — supersedes this row's earlier NFL placeholder; see DECISIONS 2026-08-11. As of 2026-08-13: data layer, scoring/grading, live scores, admin pool creation/slate ops, and player-UI Phases 1–2 (theme + real Pool Detail/leaderboard) are all shipped (PR #40–#49, see status-log rows above). Still open: the weekly picks builder (Phase 3) and dashboard/join reachability (Phase 4). | High (later) | 🟡 |
